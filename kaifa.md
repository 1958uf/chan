...
* 讨论组：[Telegram](https://link.gitcode.com/?target=https%3A%2F%2Ft.me%2Fzen_python&from=https%3A%2F%2Fgitcode.com%2Fgh_mirrors%2Fch%2Fchan.py%2Fblob%2Fmain%2Fquick_guide.md&lang=zh&theme=white)
  * 为什么用TG：因为后进来的朋友可以看到以前的讨论（啥时候墙内也有类似的，我再开个讨论的）
  * 没法科学上网，没有tg账号：有问题可以邮件联系我
* 欢迎star，满足一下我的虚荣心
* 如有打赏，万分感谢！
* 视频介绍：[20230909交流会录屏](https://link.gitcode.com/?target=https%3A%2F%2Fwww.bilibili.com%2Fvideo%2FBV1nu411c7oG%2F&from=https%3A%2F%2Fgitcode.com%2Fgh_mirrors%2Fch%2Fchan.py%2Fblob%2Fmain%2Fquick_guide.md&lang=zh&theme=white);
...
* 支持开发自己的数据源接入这个计算（参见[数据接入速成班](https://gitcode.com/gh_mirrors/ch/chan.py/blob/main/quick_guide.md#%E6%95%B0%E6%8D%AE%E6%8E%A5%E5%85%A5%E9%80%9F%E6%88%90%E7%8F%AD)）
* 支持让你取出算好的元素组装你自己的策略（参见[取出缠论元素组织策略](https://gitcode.com/gh_mirrors/ch/chan.py/blob/main/quick_guide.md#%E5%8F%96%E5%87%BA%E7%BC%A0%E8%AE%BA%E5%85%83%E7%B4%A0%E7%BB%84%E7%BB%87%E7%AD%96%E7%95%A5)）
...
![](https://raw.gitcode.com/gh_mirrors/ch/chan.py/files/main/Image/frame.png)
...
首先，完整版和开源版的区别参见[写在前面](https://gitcode.com/gh_mirrors/ch/chan.py/blob/main/quick_guide.md#%E5%86%99%E5%9C%A8%E5%89%8D%E9%9D%A2)章节，差异部分主要为个人策略和交易引擎**定制开发**的代码，不具备可泛化性，各位拿了也没啥用！

> 另外机器学习模型相关的代码和一些特征，也由于并非所有知识产权都归属于我，所以是没法对外提供的。 关于这部分的思路，B站发的[交流会视频](https://link.gitcode.com/?target=https%3A%2F%2Fwww.bilibili.com%2Fvideo%2FBV1iB421k74C%2F&from=https%3A%2F%2Fgitcode.com%2Fgh_mirrors%2Fch%2Fchan.py%2Fblob%2Fmain%2Fquick_guide.md&lang=zh&theme=white)基本已经介绍过了，感兴趣的可以去看看。
...
线段逻辑简要说明可以参考[线段](https://gitcode.com/gh_mirrors/ch/chan.py/blob/main/quick_guide.md#%E7%BA%BF%E6%AE%B5)一章，如果不太能理解划段的结果，可以在画图开关里面打开`plot_eigen`开关绘制出特征序列辅助分析。
...
很多用户使用，其实不需要细看整个代码是怎么实现了，假装相信框架没BUG，通过直接提取框架计算好的缠论元素来组装策略（具体内部元素结构的设计参见[B站视频](https://link.gitcode.com/?target=https%3A%2F%2Fwww.bilibili.com%2Fvideo%2FBV1nu411c7oG%2F&from=https%3A%2F%2Fgitcode.com%2Fgh_mirrors%2Fch%2Fchan.py%2Fblob%2Fmain%2Fquick_guide.md&lang=zh&theme=white)）；
...
具体demo参见[strategy_demo.py](https://gitcode.com/gh_mirrors/ch/chan.py/blob/main/Debug/strategy_demo.py)
...
具体使用case可以参考[strategy_demo.py](https://gitcode.com/gh_mirrors/ch/chan.py/blob/main/Debug/strategy_demo2.py)
...
解决方法：参考[strategy_demo.py](https://gitcode.com/gh_mirrors/ch/chan.py/blob/main/Debug/strategy_demo3.py) 原理是：
...
机器学习相关演示参见项目`machinelearning`分支[strategy_demo5.py](https://gitcode.com/gh_mirrors/ch/chan.py/blob/main/Debug/strategy_demo5.py)，里面演示了包括：
